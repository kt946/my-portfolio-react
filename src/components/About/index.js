    ...
    <section id="about" className="text-white">
      ...
      <div className="hero text-center d-flex flex-column justify-content-center align-items-center">
        <h1 className="px-2 display-6">
          ...
          <br />
          <span className="brand animate__animated animate__fadeInLeft animate_slow delay-2">
            Kyle
          </span>
          &nbsp;
          <span className="brand animate__animated animate__fadeInRight animate_slow delay-2">
            Tang
          </span>
          <br />
